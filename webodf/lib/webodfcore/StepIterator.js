 ...
 *
 * @constructor
 * @param {!webodfcore.PositionFilter} filter Filter to apply to the iterator positions
 * @param {!webodfcore.PositionIterator} iterator Substree to search for step within. Generally a paragraph or document root
 */
webodfcore.StepIterator = function StepIterator(filter, iterator) {
    "use strict";
     ...
     *
     * @return {!webodfcore.StepIterator.StepSnapshot}
     */
    this.snapshot = function() {
        return new webodfcore.StepIterator.StepSnapshot(container(), offset());
    };
     ...
     *
     * @param {!webodfcore.StepIterator.StepSnapshot} snapshot
     * @return {undefined}
     */
 ...
 * @param {!number} offset
 */
webodfcore.StepIterator.StepSnapshot = function (container, offset) {
    "use strict";
