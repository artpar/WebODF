 ...
 */
webodfcore.PositionFilterChain = function PositionFilterChain() {
    "use strict";

    var /**@type{!Array.<!webodfcore.PositionFilter|!webodfcore.PositionFilterChain>}*/
        filterChain = [],
        /**@const*/
     ...
     * @param {!webodfcore.PositionFilter|!webodfcore.PositionFilterChain} filterInstance
     * @return {undefined}
     */
