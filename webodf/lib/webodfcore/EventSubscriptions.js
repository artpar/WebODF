 ...
 */
webodfcore.EventSubscriptions = function () {
    "use strict";
     var /**@type{!Array.<!{eventSource: !webodfcore.EventSource, eventid: !string, callback: !Function}>}*/
         subscriptions = [],
         /**@type {!webodfcore.EventNotifier}*/
         frameEventNotifier = new webodfcore.EventNotifier(),
         /**@type{!Object.<!string,!Array.<!{frameEventId: !string, eventSource: !Object, task: !webodfcore.ScheduledTask}>>}*/
         frameSubscriptions = {},
         /**@type{!number}*/
         nextFrameEventId = 0;
     ...
     * @param {!webodfcore.EventSource} eventSource
    ...
    this.addFrameSubscription = function (eventSource, eventid, callback) {
        ...
        if (!frameSubscription) {
            ...
            frameSubscription = {
                ...
                eventSource: eventSource,
                task: webodfcore.Task.createRedrawTask(function() {
    ...
    function unsubscribeAll() {
        ...
        webodfcore.Async.destroyAll(cleanup, function() { });
