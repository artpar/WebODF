...
(function () {
     ...
     * @constructor
     */
    webodfcore.DomUtilsImpl = function DomUtilsImpl() {
        var /**@type{?Range}*/
            sharedRange = null;
        ...
        /**
         * @param {!webodfcore.DomUtilsImpl} self
         */
        function init(self) {
    ...
    /**
     * @type {!webodfcore.DomUtilsImpl}
     */
    webodfcore.DomUtils = new webodfcore.DomUtilsImpl();
}());
