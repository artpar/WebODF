...
/*global Node, NodeFilter, runtime, webodfcore, gui, xmldom, ops*/
 ...
 */
webodfcore.PositionIteratorTests = function PositionIteratorTests(runner) {
    "use strict";
    /**
     * @constructor
    ...
    function createWalker(xml) {
        t.doc = parseXML(xml);
        t.iterator = new webodfcore.PositionIterator(t.doc.documentElement, 0,
            filter);
    }
    function create() {
        createWalker("<a/>");
    ...
    function testSetUnfilteredPosition_FirstStepInRejectedRootNode() {
        ...
        t.iterator = new webodfcore.PositionIterator(t.doc.documentElement.firstChild, 0,
            filter);
        t.iterator.setUnfilteredPosition(t.doc.documentElement, 0);
...
webodfcore.PositionIteratorTests.prototype.description = function () {
    "use strict";
