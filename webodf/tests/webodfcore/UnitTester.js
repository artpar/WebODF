...
/*global runtime, Runtime, webodfcore, Node, Element*/
 ...
 */
webodfcore.AsyncTestData;
/**
 * @interface
 */
webodfcore.UnitTest = function UnitTest() {"use strict"; };
/**
 * @return {undefined}
 */
webodfcore.UnitTest.prototype.setUp = function () {"use strict"; };
/**
 * @return {undefined}
 */
webodfcore.UnitTest.prototype.tearDown = function () {"use strict"; };
/**
 * @return {!string}
 */
webodfcore.UnitTest.prototype.description = function () {"use strict"; };
/**
 * @return {!Array.<!webodfcore.TestData>}
 */
webodfcore.UnitTest.prototype.tests = function () {"use strict"; };
/**
 * @return {!Array.<!webodfcore.AsyncTestData>}
 */
webodfcore.UnitTest.prototype.asyncTests = function () {"use strict"; };

/**
 * @return {!HTMLDivElement}
 */
webodfcore.UnitTest.provideTestAreaDiv = function () {
    "use strict";
 ...
 * @return {undefined}
 */
webodfcore.UnitTest.cleanupTestAreaDiv = function () {
    "use strict";
    var maindoc = runtime.getWindow().document,
        testarea = maindoc.getElementById('testarea');
 ...
 * @return {?Document}
 */
webodfcore.UnitTest.createXmlDocument = function (rootElementName, xmlBodyString, namespaceMap) {
    "use strict";
    var /**@type{!string}*/
 ...
 * @return {?Document}
 */
webodfcore.UnitTest.createOdtDocument = function (xml, namespaceMap) {
    "use strict";
    return webodfcore.UnitTest.createXmlDocument("office:document", xml, namespaceMap);
};
 ...
 * @constructor
 */
webodfcore.UnitTestLogger = function UnitTestLogger() {
    "use strict";
 ...
 * @param {!webodfcore.UnitTestLogger} logger
 */
webodfcore.UnitTestRunner = function UnitTestRunner(resourcePrefix, logger) {
    "use strict";
    var /**@type{number}*/
        failedTests = 0,
        /**@type{number}*/
 ...
 * @constructor
 */
webodfcore.UnitTester = function UnitTester() {
    "use strict";
    var self = this,
        /**@type{!number}*/
        failedTests = 0,
        logger = new webodfcore.UnitTestLogger(),
        results = {},
     ...
     *
     * @param {!function(new:webodfcore.UnitTest,webodfcore.UnitTestRunner)} TestClass
    ...
    this.runTests = function (TestClass, callback, testNames) {
        var testName = Runtime.getFunctionName(TestClass) || "",
            /**@type{!string}*/
            tname,
            runner = new webodfcore.UnitTestRunner(self.resourcePrefix, logger),
        ...
        /**
         * @param {!Array.<!webodfcore.AsyncTestData>} todo
         * @return {undefined}
         */
