 ...
 */
webodfcore.EventSubscriptionsTests = function EventSubscriptionsTests(runner) {
    "use strict";
    var r = runner,
        t;
    ...
    this.setUp = function () {
        t = {
            subscriptions: new webodfcore.EventSubscriptions(),
            calls: {}
        };
    };
    ...
    function addSubscription_RegistersNewDirectSubscription() {
        var source1 = new webodfcore.EventNotifier(["event1"]),
            source2 = new webodfcore.EventNotifier(["event2"]);
    ...
    function addFrameSubscription_RegistersNewFrameSubscription() {
        ...
        webodfcore.Task.processTasks(); // Force redraw tasks to execute
    ...
    function addFrameSubscription_DifferentControllersWithSameEventId_RegistersNewFrameSubscription() {
        var source1 = new webodfcore.EventNotifier(["event"]),
            source2 = new webodfcore.EventNotifier(["event"]);
...
webodfcore.EventSubscriptionsTests.prototype.description = function () {
    "use strict";
