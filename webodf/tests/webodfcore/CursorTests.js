 ...
 */
webodfcore.CursorTests = function CursorTests(runner) {
    "use strict";
    ...
    function setupEmptyRootNode() {
        var root = domDocument.createElementNS(ns, "p"),
            cursor = new webodfcore.Cursor(domDocument, "Joe");
...
webodfcore.CursorTests.name = "CursorTests";
webodfcore.CursorTests.prototype.description = function () {
    "use strict";
