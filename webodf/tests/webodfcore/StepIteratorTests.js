...
/*global webodfcore, runtime, Node*/
 ...
 */
webodfcore.StepIteratorTests = function StepIteratorTests(runner) {
    "use strict";
    var r = runner, t = {},
    ...
    this.setUp = function () {
        ...
        t = {
            ...
            steps: new webodfcore.StepIterator(new LeftOfNumberFilter(), iterator)
        };
    };
...
webodfcore.StepIteratorTests.name = "StepIteratorTests";
webodfcore.StepIteratorTests.prototype.description = function () {
    "use strict";
